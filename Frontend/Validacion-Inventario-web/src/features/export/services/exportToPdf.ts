...
export async function exportToPdf(data: PhysicalInventoryItem[], customName: string): Promise<void> {
  ...
  await saveExportFile(buildFilenameWithExtension(customName, "pdf"), bytes, "application/pdf");
}